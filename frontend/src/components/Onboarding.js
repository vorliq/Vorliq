...
const steps = [
  {
    ...
    body:
      "Vorliq is a community savings bank built on its own blockchain with the VLQ coin. The system is built around Vorliq's native ledger, user-controlled wallets, and transparent community records.",
  },
  {
