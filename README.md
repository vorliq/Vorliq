...
Current public version: 1.0.0 stable. Release metadata, roadmap, changelog, production readiness, migration readiness, PostgreSQL readiness planning, and upgrade guidance are available at https://vorliq.org/releases, https://vorliq.org/roadmap, https://vorliq.org/readiness, https://vorliq.org/migration-readiness, https://vorliq.org/api/version/metadata, https://vorliq.github.io/Vorliq/postgres-readiness.html, and https://vorliq.github.io/Vorliq/upgrades.html.
...
Vorliq includes encrypted browser wallet storage, local key storage on mobile, dark and light mode, persistent notifications, push notification support through Expo, node diagnostics, rotating logs, atomic JSON persistence with backup-before-write protection, derived read indexes, storage and index health reporting, PostgreSQL migration readiness artifacts, database migration dry-run and import simulation preparation, a public node registry, GitHub Pages documentation, a full test suite, GitHub Actions CI, and production deployment documentation.
