...
- Community offer board for buy/sell coordination.
...
- `blockchain/` - Python blockchain node, wallet, transaction, mining, storage, registry, governance, lending, and exchange logic.
...
6. On Windows, `start.bat` starts the blockchain API, backend API, React frontend, and heartbeat helper in separate windows.
