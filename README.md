...
Current public version: 1.0.0 stable. Release metadata, roadmap, changelog, production readiness, and upgrade guidance are available at https://vorliq.org/releases, https://vorliq.org/roadmap, https://vorliq.org/readiness, https://vorliq.org/api/version/metadata, and https://vorliq.github.io/Vorliq/upgrades.html.
...
Vorliq includes encrypted browser wallet storage, local key storage on mobile, dark and light mode, persistent notifications, push notification support through Expo, node diagnostics, rotating logs, atomic JSON persistence with backup-before-write protection, derived read indexes, storage and index health reporting, a public node registry, GitHub Pages documentation, a full test suite, GitHub Actions CI, and production deployment documentation.
...
Public network proof is available through the status page, the readiness gate, the recovery guide, the upgrade guide, the storage reliability guide, the derived index guide, public audit exports, and the machine-readable network manifest. Users and developers can check https://status.vorliq.org, https://vorliq.org/readiness, https://vorliq.github.io/Vorliq/readiness.html, https://vorliq.github.io/Vorliq/recovery.html, https://vorliq.github.io/Vorliq/upgrades.html, https://vorliq.github.io/Vorliq/storage.html, https://vorliq.github.io/Vorliq/indexes.html, https://vorliq.github.io/Vorliq/audit.html, https://vorliq.github.io/Vorliq/api-versioning.html, https://vorliq.github.io/Vorliq/examples.html, https://vorliq.org/api/readiness, https://vorliq.org/api/indexes/health, https://vorliq.org/api/audit/manifest, https://vorliq.org/api/version/metadata, and https://vorliq.org/api/network/manifest. The build and deployment process is public through GitHub Actions at https://github.com/vorliq/Vorliq/actions.
