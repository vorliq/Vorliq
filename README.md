...
Current public version: 1.0.0 stable. Release metadata, roadmap, changelog, production readiness, migration readiness, storage adapter interface, PostgreSQL adapter planning, PostgreSQL readiness planning, PostgreSQL shadow migration rehearsal, and upgrade guidance are available at https://vorliq.org/releases, https://vorliq.org/roadmap, https://vorliq.org/readiness, https://vorliq.org/migration-readiness, https://vorliq.org/api/version/metadata, https://vorliq.github.io/Vorliq/storage-adapter-interface.html, https://vorliq.github.io/Vorliq/postgres-adapter.html, https://vorliq.github.io/Vorliq/postgres-readiness.html, https://vorliq.github.io/Vorliq/postgres-shadow-migration.html, and https://vorliq.github.io/Vorliq/upgrades.html.
