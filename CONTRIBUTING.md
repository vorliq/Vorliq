...
Python code should follow PEP8 style and should be written clearly enough for another contributor to understand the blockchain logic without guessing. JavaScript code should be clean, readable, and consistent with the existing React and Express structure. All new features should include a brief test or a clear manual verification note that shows the feature works as intended.
